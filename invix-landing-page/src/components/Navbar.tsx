...
// Pastikan SECTION_IDS memuat keys: features, templates, pricing, faq, cta (lihat catatan di bawah)
type Target = keyof typeof SECTION_IDS;
...
export default function Navbar() {
  ...
  // === Logic asli: di home -> scroll; di luar home -> navigate('/{target}')
...
function ArrowIcon() {
  return (
    <svg viewBox="0 0 24 24" className="h-4 w-4">
      <path fill="currentColor" d="m13.5 5-1.4 1.4L16.7 11H4v2h12.7l-4.6 4.6l1.4 1.4L21 12z" />
    </svg>
  );
}
