...
>
  ...
  <div className="pointer-events-none absolute inset-0 -z-10">
    <div className="absolute -top-24 -left-24 h-72 w-72 rounded-full bg-yellow-300/35 blur-3xl" style={{ animation:"float 8s ease-in-out infinite" }}/>
    <div className="absolute -bottom-24 -right-24 h-96 w-96 rounded-full bg-[#4351BC]/25 blur-3xl" style={{ animation:"slowSpin 60s linear infinite" }}/>
  </div>
 ...
 <ul className="mt-6 flex flex-wrap justify-center gap-2 text-xs text-[#4351BC]">
    ...
    <div className="mt-8 max-w-xl mx-auto animate-[fadeUp_900ms_ease-out_forwards] opacity-0">
      <div className="rounded-2xl border border-slate-200 bg-white/80 shadow-lg p-3">
        <div className="rounded-xl bg-gradient-to-br from-[#4351BC] via-[#4351BC] to-yellow-300 p-1">
          <div className="rounded-xl bg-white p-5">
            <div className="h-56 rounded-xl bg-slate-100 flex items-center justify-center" style={{ animation:"float 7s ease-in-out infinite" }}>
