...
`}</style>	
                ...
                <div className="mx-auto w-full max-w-8xl px-4 sm:px-6 lg:px-8 text-center mt-8">
					...
					{/* Chips */}
					<ul className="mt-4 flex flex-wrap justify-center gap-3 text-[11px] sm:text-xs text-[#4351BC] mt-8">
  {/* 1 */}
  <li
    ...
    style={{ animation: "chipFloat 6s ease-in-out infinite, chipDrift 7s ease-in-out infinite", animationDelay: "0s" }} >
  ...
  <li
    className="inline-flex items-center gap-1.5 rounded-full bg-gradient-to-r from-[#3B5D99] to-[#4C7A99] text-white px-3 py-1.5 font-semibold ring-1 ring-[#4C7A99]/80 shadow-sm
               transition-all duration-300 hover:scale-105 hover:shadow-md focus:outline-none focus-visible:ring-2 focus-visible:ring-indigo-500/80"
    style={{ animation: "chipFloat 6.5s ease-in-out infinite, chipDrift 7.5s ease-in-out infinite", animationDelay: "0.15s" }}
  >
  ...
  <li
    className="inline-flex items-center gap-1.5 rounded-full bg-gradient-to-r from-[#3B5D99] to-[#4C7A99] text-white px-3 py-1.5 font-semibold ring-1 ring-[#4C7A99]/80 shadow-sm
               transition-all duration-300 hover:scale-105 hover:shadow-md focus:outline-none focus-visible:ring-2 focus-visible:ring-indigo-500/80"
    style={{ animation: "chipFloat 7s ease-in-out infinite, chipDrift 8s ease-in-out infinite", animationDelay: "0.3s" }}
  >
  ...
  <li
    className="inline-flex items-center gap-1.5 rounded-full bg-gradient-to-r from-[#3B5D99] to-[#4C7A99] text-white px-3 py-1.5 font-semibold ring-1 ring-[#4C7A99]/80 shadow-sm
               transition-all duration-300 hover:scale-105 hover:shadow-md focus:outline-none focus-visible:ring-2 focus-visible:ring-indigo-500/80"
    style={{ animation: "chipFloat 7.5s ease-in-out infinite, chipDrift 8.5s ease-in-out infinite", animationDelay: "0.45s" }}
  >
  ...
  <li
    className="inline-flex items-center gap-1.5 rounded-full bg-gradient-to-r from-[#3B5D99] to-[#4C7A99] text-white px-3 py-1.5 font-semibold ring-1 ring-[#4C7A99]/80 shadow-sm
               transition-all duration-300 hover:scale-105 hover:shadow-md focus:outline-none focus-visible:ring-2 focus-visible:ring-indigo-500/80"
    style={{ animation: "chipFloat 6.25s ease-in-out infinite, chipDrift 7.25s ease-in-out infinite", animationDelay: "0.6s" }}
  >
  ...
  <li
    className="inline-flex items-center gap-1.5 rounded-full bg-gradient-to-r from-[#3B5D99] to-[#4C7A99] text-white px-3 py-1.5 font-semibold ring-1 ring-[#4C7A99]/80 shadow-sm
               transition-all duration-300 hover:scale-105 hover:shadow-md focus:outline-none focus-visible:ring-2 focus-visible:ring-indigo-500/80"
    style={{ animation: "chipFloat 6.75s ease-in-out infinite, chipDrift 7.75s ease-in-out infinite", animationDelay: "0.75s" }}
  >
