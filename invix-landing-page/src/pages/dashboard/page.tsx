...
const DashboardPage: React.FC = () => {
	...
	const websiteTemplates: Template[] = [
		{
			...
			imageUrl: "https://via.placeholder.com/400x300?text=Template+Pernikahan",
		},
		{
			id: 102,
			title: "Template Ulang Tahun Modern",
			imageUrl: "https://via.placeholder.com/400x300?text=Template+Ulang+Tahun",
		},
		{
			id: 103,
			title: "Template Seminar Profesional",
			imageUrl: "https://via.placeholder.com/400x300?text=Template+Seminar",
		},
		{
			id: 104,
			title: "Template Acara Kantor",
			imageUrl:
				"https://via.placeholder.com/400x300?text=Template+Acara+Kantor",
		},
		{
			id: 105,
			title: "Template Reuni",
			imageUrl: "https://via.placeholder.com/400x300?text=Template+Reuni",
		},
		{
			id: 106,
			title: "Template Tasyakuran",
			imageUrl: "https://via.placeholder.com/400x300?text=Template+Tasyakuran",
		},
		{
			id: 107,
			title: "Template Launching Produk",
			imageUrl: "https://via.placeholder.com/400x300?text=Template+Launching",
		},
		{
			id: 108,
			title: "Template Khitanan",
	...
	const handleStartTemplate = (id: number) => {
		...
		// Logic untuk memulai invitation baru dari template
	};
