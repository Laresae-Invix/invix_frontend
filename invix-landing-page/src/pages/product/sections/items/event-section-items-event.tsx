	...
	const products = [
		{
			...
			link: "http://localhost:5173/category_wisuda/wisuda_one",
			imageUrl: event_satu,
		},
		{
			id: 2,
			...
			link: "http://localhost:5173/category_wisuda/wisuda_two",
			imageUrl: event_dua,
		},
		{
			id: 3,
		...
		},
		{
			...
			{
			id: 6,
			title: "Event Wisuda 6",
			description: "Deskripsi singkat produk Event 6.",
			link: "http://localhost:5173/category_wisuda/wisuda_six",
			// imageUrl: event_lima,
		},
	];
